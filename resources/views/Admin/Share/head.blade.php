    ...
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="/assets_UI/assets_admin/css/vendors/scrollbar.css">
    <link rel="stylesheet" type="text/css" href="/assets_UI/assets_admin/css/vendors/animate.css">
    <link rel="stylesheet" type="text/css" href="/assets_UI/assets_admin/css/vendors/chartist.css">
    <link rel="stylesheet" type="text/css" href="/assets_UI/assets_admin/css/vendors/date-picker.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
